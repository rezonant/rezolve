...
public class RemoteShellEntity extends MachineEntity implements ICableEndpoint, IContainerListener {
	...
	@SidedProxy(
			clientSide = "com.astronautlabs.mc.rezolve.machines.remoteShell.RemoteShellClientProxy",
			serverSide = "com.astronautlabs.mc.rezolve.machines.remoteShell.RemoteShellServerProxy"
	)
