...
import com.astronautlabs.mc.rezolve.core.OverridePlayerPosition;
...
public class RemoteShellEntity extends MachineEntity implements IContainerListener, CableNetwork.IListener {
	...
	@SidedProxy(
			clientSide = "com.astronautlabs.mc.rezolve.network.machines.remoteShell.RemoteShellClientProxy",
			serverSide = "com.astronautlabs.mc.rezolve.network.machines.remoteShell.RemoteShellServerProxy"
	)
	...
	public void activate(BlockPos activatedMachine, EntityPlayer player) {
		...
		OverridePlayerPosition.setPlayerOverridePosition(player.getUniqueID(), activatedMachine);
	...
	public void updatePeriodically() {
		...
		synchronized (activatedPlayers) {
			...
			for (EntityPlayer player : deactivatedPlayers) {
				...
				OverridePlayerPosition.clearPlayerOverridePosition(player.getUniqueID());
