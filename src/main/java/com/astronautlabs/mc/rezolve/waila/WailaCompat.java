...
import com.astronautlabs.mc.rezolve.mobs.core.EntityProvider;
...
public class WailaCompat implements IWailaDataProvider {
	...
	public static void load(IWailaRegistrar registrar) {
		...
		registrar.registerBodyProvider(p, EntityDragon.class);
		registrar.registerHeadProvider(p, EntityDragon.class);
		registrar.registerTailProvider(p, EntityDragon.class);

		registrar.registerBodyProvider(p, EntityDragonPart.class);
		registrar.registerHeadProvider(p, EntityDragonPart.class);
		registrar.registerTailProvider(p, EntityDragonPart.class);
	}
