...
//		if ("net.minecraft.entity.player.Player".equals(transformedName))
...
//
//		System.out.println("REZOLVE Transforming Player class with name: "+name+" -- Transformed name: "+transformedName);
//
...
//		String targetInvokedMethodDesc = "(Lnet/minecraft/entity/player/Player;)Z";
//
...
//			int target_index = -1;
//
//			System.out.println("REZOLVE: Player method "+m.name);
...
//
//				// mv.visitFieldInsn(GETFIELD, "net/minecraft/entity/player/Player", "openContainer", "Lnet/minecraft/inventory/Container;");
//				// mv.visitVarInsn(ALOAD, 0); // loading the player onto the stack
//				// // stack is [container, player]
//				// mv.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/inventory/Container", "canInteractWith", "(Lnet/minecraft/entity/player/Player;)Z", false);
//
...
//
//				System.out.println("[Rezolve/Player.onUpdate] Patching Complete!");
//			}
//
//			break;
//		}
