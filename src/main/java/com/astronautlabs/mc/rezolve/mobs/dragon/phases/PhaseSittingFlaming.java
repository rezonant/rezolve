...
public class PhaseSittingFlaming extends PhaseSittingBase
{
	...
	public void doClientRenderEffects()
	{
		...
		if (this.flameTicks % 2 == 0 && this.flameTicks < 10)
		{
			...
			for (int i = 0; i < 8; ++i)
			{
				...
				for (int j = 0; j < 6; ++j)
				{
					this.dragon.worldObj.spawnParticle(EnumParticleTypes.FLAME, d3, d4, d5, -vec3d.xCoord * 0.07999999821186066D * (double)j, -vec3d.yCoord * 0.6000000238418579D, -vec3d.zCoord * 0.07999999821186066D * (double)j, new int[0]);
				}
	...
	public DragonPhaseList<PhaseSittingFlaming> getPhaseList()
	{
		return DragonPhaseList.SITTING_FLAMING;
	}
