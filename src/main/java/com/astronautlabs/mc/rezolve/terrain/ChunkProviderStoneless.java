...
//
//public class ChunkProviderStoneless implements IChunkGenerator {
...
//	double[] depthRegion;
//
//	public ChunkProviderStoneless(World worldIn, long seed, boolean mapFeaturesEnabledIn, String p_i46668_5_)
//	{
//		{
...
//	}
//
//	public void removeStoneBlocks(int cx, int cz, ChunkPrimer primer) {
//		for (int x = 0, maxX = 16; x < maxX; ++x) {
//			for (int y = 0, maxY = 255; y < maxY; ++y) {
...
//		}
//
//		this.removeStoneBlocks(x, z, chunkprimer);
//
