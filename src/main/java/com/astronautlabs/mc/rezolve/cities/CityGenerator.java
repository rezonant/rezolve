...
//
//	public Chunk[] getNeighborCities(Level world, int chunkX, int chunkZ) {
...
//	}
//
//	public static BlockState[] BUILDING_MATERIALS = new BlockState[] {
...
//	};
//
//	public static BlockState[] FLUSH_GLASS_MATERIALS = new BlockState[] {
//		Blocks.GLASS.getDefaultState()
//	};
//
//	public static BlockState[] GLASS_PANE_MATERIALS = new BlockState[] {
//		Blocks.GLASS_PANE.getDefaultState()
//	};
//
//	public static BlockState[] FLOOR_MATERIALS = new BlockState[] {
...
//	};
//
//	public void generateTower(Random random, Level world, int posX, int posY, int posZ, int sizeX, int sizeZ, int floors) {
//
...
//
//		BlockState buildingMaterial = BUILDING_MATERIALS[random.nextInt(BUILDING_MATERIALS.length)];
//		BlockState glassMaterial;
//		BlockState floorMaterial = FLOOR_MATERIALS[random.nextInt(FLOOR_MATERIALS.length)];
//
//		if (flushWindows) {
...
//
//						BlockState wallMaterial = buildingMaterial;
...
//	}
//
//	public boolean spaceForMegaStructureAt(Level world, int chunkX, int chunkZ, int chunkSizeX, int chunkSizeZ) {
...
//	}
//
//	public int[] findSpaceForMegaStructure(Level world, int chunkX, int chunkZ, int chunkSizeX, int chunkSizeZ) {
...
//	}
//
//	public void markSpaceUsed(Level world, int chunkX, int chunkZ, int chunkCount) {
//		markSpaceUsed(world, chunkX, chunkZ, chunkCount, chunkCount);
//	}
//
//	public void markSpaceUsed(Level world, int chunkX, int chunkZ, int chunkSizeX, int chunkSizeZ) {
//		for (int x = chunkX, maxX = chunkX + chunkSizeX; x < maxX; ++x) {
//			for (int z = chunkZ, maxZ = chunkZ + chunkSizeZ; z < maxZ; ++z) {
...
//	}
//
//	public void markSpaceUsed(Level world, int chunkX, int chunkZ) {
//		world.setBlockState(
...
//	}
//
//	public boolean isSpaceUsed(Level world, int chunkX, int chunkZ) {
//
//		BlockPos indicatorBlockPos = new BlockPos(chunkX * 16, 0, chunkZ * 16);
//		BlockState indicatorBlock = world.getBlockState(indicatorBlockPos);
...
//	}
//
//	private void drawStandardRoads(Level world, int chunkX, int groundY, int chunkZ, int chunkSize) {
//
//		// Draw roads
//
...
//	}
//
//	private void drawStandardSidewalks(Level world, int chunkX, int groundY, int chunkZ, int chunkSize) {
//
//		// Draw the sidewalks
//
//		for (int x = 0, maxX = chunkSize; x < maxX; ++x) {
...
//	}
//
//	private void prepareSpace(Level world, int chunkX, int groundY, int chunkZ, int chunkSize, BlockState groundBlock) {
//		this.prepareSpace(world, chunkX, groundY, chunkZ, chunkSize, groundBlock, Blocks.STONE.getDefaultState());
//	}
//
//	private void prepareSpace(Level world, int chunkX, int groundY, int chunkZ, int chunkSize, BlockState groundBlock, BlockState undergroundBlock) {
//
//		// Flatten that shit.
//
//		for (int x = 0, maxX = chunkSize; x < maxX; ++x) {
...
//	}
//
//	private void generatePark(Random rand, int chunkX, int chunkZ, int chunkSize, Level world, IChunkGenerator chunkGenerator,
...
//				BlockState sapling = Blocks.SAPLING.getStateFromMeta(rand.nextInt(6));
//				world.setBlockState(
//					saplingPos,
//					sapling,
//					2
...
//		Level world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider)
//	{
//
...
//
//	@Override
//	public void generate(Random rand, int chunkX, int chunkZ, Level world, IChunkGenerator chunkGenerator,
//			IChunkProvider chunkProvider) {
//
